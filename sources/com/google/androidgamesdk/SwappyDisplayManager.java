...
public class SwappyDisplayManager implements DisplayManager.DisplayListener {
    ...
    private class C0004a extends Thread {
        ...
        private C0004a() {
            this.f10c = new ReentrantLock();
            this.f11d = this.f10c.newCondition();
        }

        /* synthetic */ C0004a(SwappyDisplayManager swappyDisplayManager, byte b) {
            this();
        }
    ...
    public SwappyDisplayManager(long j, Activity activity) {
        ...
        synchronized (this) {
            this.mLooper = new C0004a(this, (byte) 0);
            this.mLooper.start();
